...
use App\Filament\Resources\Employees\RelationManagers\AssetsHolderRelationManager;
...
class EmployeeResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Персонал';
    ...
    {
        return [
            AssetsHolderRelationManager::class,
        ];
    }
